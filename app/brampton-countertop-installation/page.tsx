...
export const metadata: Metadata = {
  title: "Brampton Countertop Installation | Same-Day Installers | 1800TOPS",
  description:
    "Professional countertop installation in Brampton. Same-day and next-day service available. Quartz, granite, and backsplash installs for homeowners and contractors.",
  keywords: [
    "Brampton countertop installation",
    "countertop installers Brampton",
    "quartz installation Brampton",
    "granite installers Brampton",
    "same day countertop Brampton",
    "kitchen countertop installation Brampton",
  ],
};
    ...
    <main className="min-h-screen bg-white text-neutral-900">
      ...
      <section className="bg-black text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-6 text-lg text-neutral-300 max-w-3xl">
            1800TOPS provides fast, reliable countertop installation across Brampton.
      ...
      <section className="py-16 max-w-5xl mx-auto px-6">
        <h2 className="text-3xl font-bold">
          Brampton Countertop Installation Experts
        </h2>

        <p className="mt-6 text-lg text-neutral-700">
          1800TOPS provides professional countertop installation services across
          Brampton, delivering fast and reliable results for residential and
      ...
      <section className="bg-neutral-50 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold">
            Brampton Countertop Installation Services
          </h2>
      ...
      <section className="bg-black text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold">
            Ready to book countertop installation in Brampton?
          </h2>
